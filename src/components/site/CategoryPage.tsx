    ...
    <SiteLayout>
      ...
      <section className="relative pt-40 pb-24 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          ...
          <h1 className="mt-5 font-display text-5xl md:text-6xl text-white leading-tight max-w-3xl">
            {title}
          </h1>
          ...
          <div className="mt-8 flex gap-3">
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 brand-gradient text-[color:var(--navy-deep)] font-semibold px-5 py-3 rounded-full glow"
            >
              Request a Quote <ArrowRight className="size-4" />
            </Link>
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 glass-strong text-white font-medium px-5 py-3 rounded-full"
            >
              Contact Sales
            </Link>
          </div>
            ...
            {[
              {
                Icon: ShieldCheck,
                t: "Verified Quality",
                d: "Pre-shipment QA and third-party inspection on request.",
              },
              {
                Icon: Award,
                t: "Global Standards",
                d: "GMP, ISO 13485 and export documentation support where applicable.",
              },
              {
                Icon: Truck,
                t: "Reliable Logistics",
                d: "Multi-modal freight with full tracking & documentation.",
              },
              {
                Icon: CheckCircle2,
                t: "Flexible MOQs",
                d: "Trial orders, scaled contracts and private-label options.",
              },
            ].map((it) => (
              <div key={it.t} className="glass rounded-2xl p-6">
                <div className="size-11 rounded-xl brand-gradient grid place-items-center text-[color:var(--navy-deep)]">
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <p className="text-white/65 mt-3 max-w-2xl">
            A curated selection from this category. Full catalogues and certificates are shared on
            request.
          </p>
            ...
            {items.map((s, i) => (
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 size-10 rounded-xl brand-gradient grid place-items-center text-[color:var(--navy-deep)]">
            ...
            {[
              {
                Icon: FileText,
                t: "Inquiry & Quote",
                d: "Share requirements, destination and quantity; receive indicative pricing.",
              },
              {
                Icon: ClipboardCheck,
                t: "Sampling & QA",
                d: "Samples, certificates and inspection options are coordinated as needed.",
              },
              {
                Icon: Package,
                t: "Supplier & Packing",
                d: "Supplier readiness, export packing and labeling details are aligned before shipment.",
              },
              {
                Icon: Plane,
                t: "Shipping & Support",
                d: "Air, sea or land freight with full documentation.",
              },
            ].map((s, i) => (
              <div key={s.t} className="relative glass rounded-3xl p-6 text-center">
                <div className="size-12 rounded-full brand-gradient grid place-items-center text-[color:var(--navy-deep)] font-bold mx-auto">
                  {i + 1}
                </div>
          ...
          <div className="glass-strong rounded-3xl p-10 md:p-14 grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-white/65 mt-4 leading-relaxed">
                Every shipment workflow is supported with relevant batch documentation, certificates
                of analysis and origin where applicable, and supplier traceability. Third-party
                inspections can be arranged on request.
              </p>
            </div>
            <ul className="space-y-3">
              {[
                ...
                <li key={q} className="flex gap-3 text-white/80">
                  <CheckCircle2 className="size-5 text-[color:var(--teal)] shrink-0 mt-0.5" /> {q}
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="relative overflow-hidden rounded-[2rem] p-12 md:p-16 text-center">
            ...
            <div className="relative">
              <h2 className="font-display text-3xl md:text-5xl text-white">
                Looking for {title.toLowerCase()}?
              </h2>
              <p className="text-white/70 mt-4 max-w-xl mx-auto">
                Send us your requirement and receive a tailored quote within one business day.
              </p>
              <Link
                to="/contact"
                className="mt-8 inline-flex items-center gap-2 brand-gradient text-[color:var(--navy-deep)] font-semibold px-7 py-4 rounded-full glow"
              >
                Request a Quote <ArrowRight className="size-4" />
              </Link>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-6 grid lg:grid-cols-2 gap-10">
          <div className="space-y-4">
            ...
            <p className="text-white/65">
              Our team replies within one business day with samples, certificates and pricing.
            </p>
            {[
              { Icon: MapPin, t: "House no 1, Adyala Road, RWP Pakistan" },
              { Icon: Phone, t: "+92-334-0007744" },
              { Icon: Mail, t: "info@thorneberry.com.pk" },
