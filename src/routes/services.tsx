...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      { title: "Healthcare Services & Export Coordination - Thorneberry" },
      {
        name: "description",
        content:
          "Explore Thorneberry's healthcare sourcing, pharmaceutical export, surgical, medical supply, documentation and logistics coordination services.",
      },
      { property: "og:title", content: "Healthcare Services - Thorneberry" },
      {
        property: "og:description",
        content: "Healthcare-only sourcing and export coordination services for global buyers.",
      },
    ],
  }),
      ...
      <section className="pt-40 pb-16">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <h1 className="mt-5 font-display text-5xl md:text-6xl text-white max-w-3xl">
            Healthcare export coordination from a single trusted partner.
          </h1>
          <p className="mt-5 text-white/65 max-w-2xl">
            Pharmaceutical sourcing, surgical instruments, medical supplies, quality documentation
            and logistics support for international healthcare buyers.
          </p>
        </div>
      </section>
          ...
          {services.map((s, i) => (
            ...
            >
              <div className="relative h-52 overflow-hidden">
                ...
                <div className="absolute top-4 left-4 size-11 rounded-xl brand-gradient grid place-items-center text-[color:var(--navy-deep)]">
              ...
              <div className="p-6">
                ...
                <Link
                  to={s.to}
                  className="mt-5 inline-flex items-center gap-1.5 text-sm text-[color:var(--teal)]"
                >
